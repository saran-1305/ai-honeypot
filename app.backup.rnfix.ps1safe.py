...
PAGE = """
<style>
  :root { --brand:#2563eb; --brandDark:#1e40af; --line:#e5e7eb; --text:#111827; }
  body { font-family: "Segoe UI", Arial, sans-serif; color: var(--text); background:#f7f7fb; }
  .topbar {
  ...
  .topbar .logo {
    ...
    background: url("/static/brand.svg") no-repeat center center;
...
</div>`r`n<div class="notice">Authorized use only. Activity may be monitored for security and training purposes.</div>`r`n<form method="POST" action="/login">
