...
PAGE = """
<h2>Employee Portal</h2>`r`n<div style="padding:6px;border:1px dashed #999;margin:8px 0;font-size:12px;">Authorized use only. Activity may be monitored for security and training purposes.</div>`r`n<form method="POST" action="/login">
